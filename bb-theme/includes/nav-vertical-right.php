<header class="fl-page-header fl-page-header-vertical fl-page-header-primary<?php FLTheme::header_classes(); ?>"<?php FLTheme::print_schema( ' itemscope="itemscope" itemtype="https://schema.org/WPHeader"' ); ?>  role="banner">
